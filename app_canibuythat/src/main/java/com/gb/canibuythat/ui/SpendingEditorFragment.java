...
public class SpendingEditorFragment extends BaseFragment {
    ...
    @BindView(R.id.target_input) EditText targetInput;
    @BindView(R.id.enabled_switch) CompoundButton enabledCB;
    @BindView(R.id.category_picker) Spinner categoryPicker;
    @BindView(R.id.occurrence_count_input) EditText occurrenceInput;
    @BindView(R.id.cycle_multiplier_input) EditText cycleMultiplierInput;
    @BindView(R.id.cycle_picker) Spinner cyclePicker;
    @BindView(R.id.from_date_picker) DateRangePicker fromDatePicker;
    @BindView(R.id.notes_input) EditText notesInput;
    @BindView(R.id.spending_events_text) TextView spendingEventsLayout;
    @BindView(R.id.source_category_lbl) TextView sourceCategoryLbl;
    @BindView(R.id.name_override_cb) CheckBox nameOverrideCB;
    @BindView(R.id.category_override_cb) CheckBox categoryOverrideCB;
    @BindView(R.id.average_override_cb) CheckBox averageOverrideCB;
    @BindView(R.id.cycle_override_cb) CheckBox cycleOverrideCB;
    @BindView(R.id.when_override_cb) CheckBox whenOverrideCB;
